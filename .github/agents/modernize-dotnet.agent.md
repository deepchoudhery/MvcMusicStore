...
mcp-servers:
    Modernization:
        type: "local"
        command: "dotnet"
        args: ["C:/Users/decho/source/repos/UpgradeAssistant/utils/benchmarks/msbench/.benchmarkTool/win-x64/Microsoft.GitHubCopilot.Modernization.Mcp.dll", "--benchmark-mode", "--extensions", "C:/Users/decho/source/repos/UpgradeAssistant/utils/benchmarks/msbench/.benchmarkTool/win-x64" ]
        tools: ["*"]
        env:
...
- Make sure no build warnings exist, keep validating until no warnings exist.
