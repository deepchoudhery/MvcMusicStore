...
namespace MvcMusicStore.Controllers
{
    ...
    public class StoreManagerController : Controller
    {
        ...
        public IActionResult Details(int? id)
        {
            ...
            Album? album = _dbContext.Albums.Include(a => a.Artist).Include(a => a.Genre).SingleOrDefault(a => a.AlbumId == id);
            if (album == null)
                return NotFound();
        ...
        [ValidateAntiForgeryToken]
        public IActionResult DeleteConfirmed([Bind("AlbumId,GenreId,ArtistId,Title,Price,AlbumArtUrl")] Album album)
        {
